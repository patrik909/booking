    ...
    return (
      <ul id="allBookingsList" className="container">
        {props.allBookings.map((booking, i) => {
          if (
            //            booking.date.includes(props.customersDateFilter) ||
            booking.firstname.includes(props.customersNameFilter) ||
            booking.lastname.includes(props.customersNameFilter)
          ) {
            return (
